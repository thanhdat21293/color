...
function setupComponentArray(componentPath, defaults) {
    ...
    array.push((0, _parser.componentParser)((0, _checkPathUtils.getCorrectPathForFile)(componentPath, 'view'), defaults, types.COMPONENT));
    ...
    if (defaults.options.vue && defaults.options.vue.components) {
        for (var component in defaults.options.vue.components) {
            if (defaults.options.vue.components.hasOwnProperty(component)) {
                ...
                array.push((0, _parser.componentParser)((0, _checkPathUtils.getCorrectPathForFile)(componentFile, 'component'), defaults, types.SUBCOMPONENT));
            }
        }
    }
    return array;
